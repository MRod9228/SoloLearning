...
public class Immigration_Status {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		if (language.equals("Spanish")) {
			...
			driver.close();
			System.out.println("Please make sure you enter either English or Spanish!");
			System.exit(0);
		};
		...
		//Currently going with cssSelector #date which is not reliable but will work since is the first one in the page anyways. 
		//Fixing once I learn more.
